...
export default {
    ...
    created(){
        this.$store.dispatch('reportQuerierStore/getUnitOne', this.$url + 'reportForms/searchClient');        
    }
}
</script>

<style lang="less">
    .withUnitOne .el-input__inner{padding:7px 15px !important;}
    .withUnitOne .el-button {padding:8px 16px !important;margin-left:10px}
</style>
