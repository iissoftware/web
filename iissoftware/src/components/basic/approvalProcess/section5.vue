    ...
    methods: {
        ...
        save() {        //保存
            ...
            tableData.forEach((item, index) => {
                if(item['nodeType'] == 0) {
                    if(item['name'] !== '') approvers.push(store['mnId'] + ',' + item['name'] + ',' + (index + 1) + ',' + Number(item['generateDocument']));
                    if(item['name1'] !== '') approvers.push(store['mnId'] + ',' + item['name1'] + ',' + (index + 1) + ',' + Number(item['generateDocument']));
                    if(item['name2'] !== '') approvers.push(store['mnId'] + ',' + item['name2'] + ',' + (index + 1) + ',' + Number(item['generateDocument']));
                    if(item['name3'] !== '') approvers.push(store['mnId'] + ',' + item['name3'] + ',' + (index + 1) + ',' + Number(item['generateDocument']));
                }
                if(item['nodeType'] == 1) {
                    if(item['name'] !== '') notifyPeoples.push(store['mnId'] + ',' + item['name'] + ',' + (index + 1) + ',' + Number(item['generateDocument']));
                    if(item['name1'] !== '') notifyPeoples.push(store['mnId'] + ',' + item['name1'] + ',' + (index + 1) + ',' + Number(item['generateDocument']));
                    if(item['name2'] !== '') notifyPeoples.push(store['mnId'] + ',' + item['name2'] + ',' + (index + 1) + ',' + Number(item['generateDocument']));
                    if(item['name3'] !== '') notifyPeoples.push(store['mnId'] + ',' + item['name3'] + ',' + (index + 1) + ',' + Number(item['generateDocument']));
                }
            });
            let obj = {
