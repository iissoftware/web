<template>
    <!--客户资料新增与修改弹窗-->
    <div class="addRow">
        <el-form label-width="120px" :model="addRowData" ref="addRowForm" status-icon :rules="addRowForm">
            ...
            <el-form-item label="客户地址：" prop="address">
                <el-input v-model="addRowData.address" ref="MA3" @keyup.enter.native="enterKey($event, 'MA4')"></el-input>
            </el-form-item>
            <el-form-item label="区域：" prop="location">
                <el-select v-model="addRowData.location" clearable filterable  ref="MA4" @keyup.enter.native="enterKey($event, 'MA5')" placeholder="选择区域">
            ...
            <el-form-item label="行业：" prop="trade">
                <el-select v-model="addRowData.trade" clearable filterable ref="MA5" @keyup.enter.native="enterKey($event, 'MA6')" placeholder="选择行业">
            ...
            <el-form-item label="电话：" prop="tel">
                <el-input v-model="addRowData.tel" ref="MA7" @keyup.enter.native="enterKey($event, 'MA8')"></el-input>
            </el-form-item>
            ...
            <el-form-item label="客户大类：" prop="clientCategoryId">
                <el-select v-model="addRowData.clientCategoryId" @change="selectNodeClick">
            ...
            <el-form-item label="客户价值分类：" prop="customerValueCategory">
                <el-select v-model="addRowData.customerValueCategory" clearable filterable ref="MA10" @keyup.enter.native="enterKey($event, 'MA11')" placeholder="选择客户价值分类">
            ...
            <el-form-item label="客户产品分类：" prop="customerProductCategory">
                <el-select v-model="addRowData.customerProductCategory" clearable filterable ref="MA11" @keyup.enter.native="enterKey($event, 'MA12')" placeholder="选择客户产品分类">
            ...
            <el-form-item label="开户名1" prop="accountNameOne" class="check">
                <el-input v-model="addRowData.accountNameOne" ref="MA12" @keyup.enter.native="enterKey($event, 'MA13')"></el-input>
            </el-form-item>
            <el-form-item label="开户银行1" prop="depositBankOne" class="check">
                <el-input v-model="addRowData.depositBankOne" ref="MA13" @keyup.enter.native="enterKey($event, 'MA14')"></el-input>
            </el-form-item>
            ...
            <el-form-item label="开户名2" prop="accountNameTwo">
                <el-input v-model="addRowData.accountNameTwo" ref="MA15" @keyup.enter.native="enterKey($event, 'MA16')"></el-input>
            </el-form-item>
            <el-form-item label="开户银行2" prop="depositBankTwo">
                <el-input v-model="addRowData.depositBankTwo" ref="MA16" @keyup.enter.native="enterKey($event, 'MA17')"></el-input>
            </el-form-item>
            ...
            <el-form-item label="开户名3" prop="accountNameThree">
                <el-input v-model="addRowData.accountNameThree" ref="MA18" @keyup.enter.native="enterKey($event, 'MA19')"></el-input>
            </el-form-item>
            <el-form-item label="开户银行3" prop="depositBankThree">
                <el-input v-model="addRowData.depositBankThree" ref="MA19" @keyup.enter.native="enterKey($event, 'MA20')"></el-input>
            </el-form-item>
            ...
            <el-form-item label="税务登记号：" prop="taxRedistrationNumber">
                <el-input v-model="addRowData.taxRedistrationNumber" ref="MA21" @keyup.enter.native="enterKey($event, 'MA22')"></el-input>
            </el-form-item>
            <el-form-item label="税率：" prop="vatRates">
                <el-select v-model="addRowData.vatRates" clearable filterable ref="MA22" @keyup.enter.native="enterKey($event, 'MA23')" placeholder="选择税率">
            ...
            <el-form-item label="所在国家：" prop="locationCountry">
                <el-select v-model="addRowData.locationCountry" @change="locationCountryData" clearable filterable ref="MA25" @keyup.enter.native="enterKey($event, 'MA26')" placeholder="选择国家">
            ...
            <el-form-item label="所在省份：" prop="locationProvince">
                <el-select v-model="addRowData.locationProvince" @change="locationProvinceData" clearable filterable ref="MA24" @keyup.enter.native="enterKey($event, 'MA25')" placeholder="选择省份">
            ...
            <el-form-item label="所在城市：" prop="locationCity">
                <el-select v-model="addRowData.locationCity" @change="locationCityData" clearable filterable ref="MA23" @keyup.enter.native="enterKey($event, 'MA24')" placeholder="选择城市">
            ...
            <el-form-item label="公司主页：" prop="homepage">
                <el-input v-model="addRowData.homepage" ref="MA26" @keyup.enter.native="enterKey($event, 'MA27')">
            ...
            <el-form-item label="法人代表：" prop="legalPersonRepresentative">
                <el-input v-model="addRowData.legalPersonRepresentative" ref="MA27" @keyup.enter.native="enterKey($event, 'MA28')"></el-input>
            </el-form-item>
            <el-form-item label="销售方式：" prop="saleMethod">
                <el-select v-model="addRowData.saleMethod" clearable ref="MA28" @keyup.enter.native="enterKey($event, 'MA29')" placeholder="选择销售方式">
            ...
            <el-form-item label="分管部门：" prop="chargeDepartment">
                ...
                <el-input v-model="addRowData.chargeDepartment" readonly style="display: none;"></el-input>
            </el-form-item>
            <el-form-item label="专营业务员：" prop="franchiseClerk">
                <el-select v-model="addRowData.franchiseClerk" clearable filterable ref="MA30" @keyup.enter.native="enterKey($event, 'MA31')" placeholder="选择专营业务员">
            ...
            <el-form-item label="信用额度：" prop="creditAmount">
                <el-input v-model="addRowData.creditAmount" ref="MA31" @keyup.enter.native="enterKey($event, 'MA32')"></el-input>
            </el-form-item>
            <el-form-item label="结算期限：" prop="settlementPeriod">
                <el-select v-model="addRowData.settlementPeriod" clearable filterable ref="MA32" @keyup.enter.native="enterKey($event, 'MA33')" placeholder="选择结算期限">
                    <el-option v-for="(items, index) in settlementPeriodList"  :label="items.detailedName" :value="items.id" :key="index"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="备注：" prop="remark">
                <el-input v-model="addRowData.remark" ref="MA33" @keyup.enter.native="addRowSave('addRowForm')"></el-input>
            </el-form-item>
            <el-form-item label="连续增加：">
                <el-checkbox v-model="addRowData.continuousInsert"></el-checkbox>
            </el-form-item>
            <el-form-item>
    ...
    export default {
        data() {
            var isDepositBankOne = (rule, value, callback) => {
                if(value == ''){
                    if(this.addRowData.accountNameOne !==''){
            ...
            var isBankAccountOne = (rule, value, callback) => {
                if(value == ''){
                    if(this.addRowData.depositBankOne !==''){
            ...
            var isDepositBankTwo = (rule, value, callback) => {
                if (value == '') {
                    if (this.addRowData.accountNameTwo !== '') {
            ...
            var isBankAccountTwo = (rule, value, callback) => {
                if(value == ''){
                    if (this.addRowData.accountNameTwo !== '' || this.addRowData.depositBankTwo !== '') {
            ...
            var isDepositBankThree = (rule, value, callback) => {
                if (value == '') {
                    if (this.addRowData.accountNameThree !== '') {
            ...
            var isBankAccountThree = (rule, value, callback) => {
                if(value == ''){
                    if (this.addRowData.accountNameThree !== '' || this.addRowData.depositBankThree !== '') {
        ...
        watch: {
            department(){
                if(this.department.length>0){
                    ...
                    this.addRowData['chargeDepartment'] = this.department[0]['id'];
                }
            }
        },
        methods: {
            ...
            locationCountryData(res){               //点击国家显示省份
                ...
                this.addRowData.locationProvince = '';
                this.addRowData.locationCity = '';
            },
            ...
            getListData(){                          //获取下拉列表的数据
                ...
                this.$http.get(this.$url + "client/findItemByName?categoryName=" + kehudalei).then(res => {
                    if(res.data.code == 20001) {
                        ...
                        if(this.$store.state.customerStore.treeclicked.length > 0 && this.$store.state.customerStore.treeclicked[0]['clientCategoryId']){
                            this.addRowData['clientCategoryId'] = this.$store.state.customerStore.treeclicked[0]['clientCategoryId'];
                        }else if(this.$store.state.customerStore.treeclickedId){
                            this.addRowData['clientCategoryId'] = this.$store.state.customerStore.treeclickedId;
                        }else{
                            this.addRowData['clientCategoryId'] = this.$store.state.customerStore.treeData[0]['id'];
                        }
                    }
                })
            },
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        let data = {
                            ...
                            location: this.addRowData['location'],
                            trade: this.addRowData['trade'],
                            linkman: this.addRowData['linkman'],
                            tel: this.addRowData['tel'],
                            fax: this.addRowData['fax'],
                            clientCategoryId: this.addRowData['clientCategoryId'],//托管商
                            customerValueCategory: this.addRowData['customerValueCategory'],
                            customerProductCategory: this.addRowData['customerProductCategory'],
                            accountNameOne: this.addRowData['accountNameOne'],
                            depositBankOne: this.addRowData['depositBankOne'],
                            bankAccountOne: this.addRowData['bankAccountOne'],
                            accountNameTwo: this.addRowData['accountNameTwo'],
                            depositBankTwo: this.addRowData['depositBankTwo'],
                            bankAccountTwo: this.addRowData['bankAccountTwo'],
                            accountNameThree: this.addRowData['accountNameThree'],
                            depositBankThree: this.addRowData['depositBankThree'],
                            bankAccountThree: this.addRowData['bankAccountThree'],
                            taxRedistrationNumber: this.addRowData['taxRedistrationNumber'],
                            vatRates: this.addRowData['vatRates'],
                            locationCountry: this.countryName,
                            locationProvince: this.provinceName,
                            locationCity: this.cityName,
                            homepage: this.addRowData['homepage'],
                            legalPersonRepresentative: this.addRowData['legalPersonRepresentative'],
                            saleMethod: this.addRowData['saleMethod'],
                            chargeDepartment: this.addRowData['chargeDepartment'],
                            franchiseClerk: this.addRowData['franchiseClerk'],
                            creditAmount: this.addRowData['creditAmount'],
                            settlementPeriod: this.addRowData['settlementPeriod'],
                            remark: this.addRowData['remark'],
                        }
                        this.$http({
                            url: this.$url + 'client/insertClient',
                            method: 'post',
                            params: data
                        }).then(res => {
                            if(res.data.code == 20001) {
                                ...
                                if(this.addRowData['continuousInsert'] == true){
                                    setTimeout(() => {
                                        this.$refs['addRowForm'].resetFields();
                                        this.addRowData['clientCategoryId'] = data.clientCategoryId;
            ...
            selectNodeClick(row) {                 //新增弹窗选择大类时触发的函数
                this.refId = row;
            },
            searchwebsite(){                        //公司主页跳转
                if(this.addRowData.homepage){
                    window.parent.location.href = 'http://' + this.addRowData.homepage;
                }else{
